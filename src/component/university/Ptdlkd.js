...
function Ptdlkd() {
    ...
    useEffect(() => {
        async function fetchApi() {
            let res = await axios.get(`https://vigorous-quiet-sherbet.glitch.me/v1/question?date=${dateQuesToday}&&part=theory&&subject=Ptdlkd`)
            setQuestionToday(
                res.data.data
            )
        }
    ...
    useEffect(() => {
        async function fetchApi() {
            let res = await axios.get(`https://vigorous-quiet-sherbet.glitch.me/v1/question?subject=Ptdlkd&&part=theory&&page=${page}&&limit=9`);
            setListQuestion(
                res.data.data
            )
    ...
    useEffect(() => {
        async function fetchApi() {
            let res = await axios.get(`https://vigorous-quiet-sherbet.glitch.me/v1/question?subject=Ptdlkd&&part=theory`);
            setLengthQuestion(
                res.data.data
            )
        }
    ...
    const Search = async (event) => {
        ...
        let res = await axios.get(`https://vigorous-quiet-sherbet.glitch.me/v1/question?question=${search}&&subject=Ptdlkd&&part=theory&&page=${page}&&limit=9`);
        setListQuestion(
            res.data.data
        )
    }
