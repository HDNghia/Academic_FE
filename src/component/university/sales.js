...
function Sales() {
    ...
    useEffect(() => {
        async function fetchApi() {
            let res = await axios.get(`https://hdnghia-academic-be.onrender.com/v1/question?date=${dateQuesToday}&&part=theory&&subject=Sales`)
            setQuestionToday(
                res.data.data
            )
        }
    ...
    useEffect(() => {
        async function fetchApi() {
            let res = await axios.get(`https://hdnghia-academic-be.onrender.com/v1/question?subject=Sales&&part=theory&&page=${page}&&limit=9`);
            setListQuestion(
                res.data.data
            )
    ...
    useEffect(() => {
        async function fetchApi() {
            let res = await axios.get(`https://hdnghia-academic-be.onrender.com/v1/question?subject=Sales&&part=theory`);
            setLengthQuestion(
                res.data.data
            )
        }
    ...
    const Search = async (event) => {
        ...
        let res = await axios.get(`https://hdnghia-academic-be.onrender.com/v1/question?question=${search}&&subject=Sales&&part=theory&&page=${page}&&limit=9`);
        setListQuestion(
            res.data.data
        )
    }
